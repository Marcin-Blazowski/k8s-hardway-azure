...
```
sudo kubectl config --kubeconfig=/var/lib/kubelet/bootstrap-kubeconfig set-cluster bootstrap --server='https://${LOADBALANCER_ADDRESS}:6443' --certificate-authority=/var/lib/kubernetes/ca.crt
